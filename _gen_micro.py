#!/usr/bin/env python3
"""Generate MicroPharm drag-and-drop games from micro_data/brick_NN.py files.
...
The MicroPharm index uses emerald (#10b981) as its identity color.
"""
...
DATA_DIR = os.path.join(ROOT, "micro_data")
OUT_DIR = ROOT
...
ENDO_IDENTITY = "#10b981"  # emerald: the hub's Microbiology identity
...
WEEKS = [
    ("Antibiotics", "Cell wall, protein synthesis, DNA & folate agents", [4, 7, 8, 9, 10, 15, 20, 21, 25, 30]),
    ("Antibiotic Spectrum & Coverage", "Which drugs cover which bugs", [14, 19, 24, 29]),
    ("Antivirals", "Herpes, HIV, influenza & RSV agents", [34, 38, 42]),
    ("Antifungals", "Drugs to treat fungal infections", [46]),
    ("Antiparasitics", "Helminthic & protozoal agents", [50]),
]
...
def make_html(game, prev_file, next_file, idx_in_palette):
    ...
    # Nav links
    index_link = (
        '<a href="micro_index.html" style="position:fixed;top:12px;left:12px;z-index:9999;'
...
def main():
    ...
    for i, g in enumerate(all_games):
        g["file"] = f"micro_{i+1:02d}_{g['slug']}.html"
    ...
    print(f"\nGenerated {len(all_games)} MicroPharm games.")
...
'''
    ...
    # The repo's original standalone games, kept as-is and listed after the
    # generated sections. index.html used to BE the antifungal game, which made
    # every other file here undiscoverable; it lives on as its own page.
    LEGACY = [
        ("Antifungal Drug Classification", "antifungal_classification.html"),
        ("Antibacterial Drug Classification", "antibacterial_hierarchical.html"),
        ("Antiviral Drug Classification", "antiviral_drugs_game.html"),
        ("Antiparasitic Drug Classification", "antiparasitic_classification_game.html"),
        ("Viral Pathogen Classification", "viral_pathogen_classification_game.html"),
        ("Fungal Identification Challenge", "fungal-identification-game.html"),
        ("Fungal & Parasitic Organisms", "fungal_parasitic_classification_game.html"),
        ("Helminth Classification", "helminth_classification_game.html"),
        ("Hospital Hero: Microbiology Mastery", "microbio_sim.html"),
    ]
    legacy_cards = "".join(
        f'    <a class="card" href="{href}" style="--c:#64748b">'
...
<div class="week" data-week>
  <div class="week-head">
    <span class="week-label">Classic Games</span>
    <span class="week-sub">The original standalone games</span>
    <span class="week-count">{len(LEGACY)} games</span>
  </div>
<section class="section" data-section>
  <div class="section-head">
    <span class="section-icon">&#127918;</span>
    <span class="section-title">Classics</span>
    <span class="section-badge">{len(LEGACY)} games</span>
  </div>
  <div class="cards">
{legacy_cards}  </div>
</section>
...
<meta charset="UTF-8">
<meta name="viewport" content="width=device-width, initial-scale=1.0">
<title>MicroPharm &ndash; Drag &amp; Drop Games</title>
<style>
...
<header>
  <h1>MicroPharm</h1>
  <p>Drag &amp; Drop Study Games &nbsp;&middot;&nbsp; Antimicrobial Pharmacology</p>
  <div class="pills">
...
document.getElementById('search').addEventListener('input', function() {{
  ...
  document.getElementById('noResults').style.display = anyVisible ? 'none' : 'block';
    ...
    with open(os.path.join(OUT_DIR, "micro_index.html"), "w", encoding="utf-8") as f:
        f.write(index_html)
    print("Created: micro_index.html")
